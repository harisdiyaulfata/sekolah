...
<link href="<?php echo base_url('assets/login/css/datepicker3.css'); ?>" rel="stylesheet">
		...
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				...
				<div class="panel-body">
					<form role="form" action="<?php echo site_url('login_admin/proses?kode=rahasia_ya'); ?>" method="post">
